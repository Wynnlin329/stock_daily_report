...
HTF_FLAG_MIN_DAYS = 10
HTF_FLAG_MAX_DAYS = 40
HTF_52W_TRADING_DAYS = 252
HTF_MONTHLY_MA_MONTHS = 12
HTF_WEEKLY_FAST_MA_WEEKS = 10
HTF_WEEKLY_SLOW_MA_WEEKS = 20
HTF_CONTRACTION_SAMPLE_DAYS = 5
HTF_VOLUME_BASELINE_DAYS = 20
HTF_PRIOR_MOVE_MIN_PCT = 50
HTF_MAX_FLAG_DEPTH_PCT = 25
HTF_MAX_RANGE_CONTRACTION_RATIO = 0.80
HTF_MAX_VOLUME_CONTRACTION_RATIO = 0.80
HTF_MIN_HIGHER_LOWS_RATIO = 0.40
HTF_MAX_DISTANCE_TO_52W_HIGH_PCT = 15
HTF_NEAR_TRIGGER_PCT = 3
HTF_MAX_EXTENSION_FROM_TRIGGER_PCT = 8
HTF_MAX_DISTANCE_TO_MA10_PCT = 10
HTF_MA_SLOPE_LOOKBACK_DAYS = 5
HTF_VALID_SCORE_MIN = 75
HTF_ISOLATED_PRICE_OUTLIER_PCT = 40
HTF_STRUCTURE_SCORE_WEIGHTS = {
    "prior_move": 25,
    "flag_depth": 15,
    "higher_lows": 10,
    "range_contraction": 10,
    "volume_contraction": 10,
    "ma_support": 10,
    "high_proximity": 10,
    "higher_timeframes": 10,
}
