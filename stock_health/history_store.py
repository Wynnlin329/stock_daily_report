...
from .data_fetcher import institutional_records_to_csv_text, records_from_csv_text, records_to_csv_text
from .models import InstitutionalTradingRecord, OhlcvRecord


def ensure_dirs(root: Path) -> None:
    for path in [root / "history", root / "data", root / "data" / "market", root / "data" / "institutional", root / "reports"]:
...
def build_history_index(
    ...
    latest_reference_day = max(all_days or institutional_days, default=None)
