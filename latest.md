...
- 執行時間：2026-06-17T16:32:37+08:00
- 交易日判定：True
- 最新市場資料日期：2026-06-17
- 是否足以執行全市場掃描：False
- 整體信心等級：medium
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| TWSE | 主資料源 | True | 200 | 2026-06-17 | True | True | True |  |
| TPEx | 主資料源 | True | 200 | 2026-06-17 | True | True | True |  |
...
- otc_ohlcv：True（10143 OTC rows parsed）
...
- institutional_trading：True（14413 institutional rows parsed from official sources）
- margin_short：False（empty_but_valid）
- material_information：True（MOPS material information query verified with 449 events）
