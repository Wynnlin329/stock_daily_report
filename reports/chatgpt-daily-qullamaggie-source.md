# ChatGPT Daily Qullamaggie Source: 2026-09-22

本資料包僅供 ChatGPT 排程研究與人工複核，不構成交易建議。

## 資料日期與 Freshness
- data_freshness: {'report_date': '2026-09-22', 'as_of_date': '2026-09-21', 'market_data_date': '2026-09-21', 'expected_market_data_date': '2026-09-21', 'latest_market_data_date': '2026-09-21', 'is_latest_trading_data_current': True, 'reason': 'Latest trading data is current'}
...
- market_regime: {'status': 'risk_on', 'score': 15, 'reasons': ['benchmark regime=risk_on'], 'risk_notes': [], 'metrics': {'listed': {'close': 47718.84, 'ma20': 46405.534999999996, 'ma50': 45085.8212, 'return_20d_pct': 6.6049}, 'otc': {'close': 412.57, 'ma20': 401.842, 'ma50': 391.1152, 'return_20d_pct': 6.8557}}}

## Setup Counts
- setup_counts: {'breakout': 0, 'episodic_pivot': 3, 'anticipation': 26, 'extended_watch': 50, 'failed_breakout': 18, 'insufficient_data': 50}

## Top Candidates
- 6875 國邑* setup=episodic_pivot score=100
- 1721 國慶科技 setup=episodic_pivot score=100
- 3027 盛達 setup=episodic_pivot score=100
- 2395 研華 setup=anticipation score=75
- 6214 精誠 setup=anticipation score=75
- 7792 安葆 setup=anticipation score=75
- 3005 神基 setup=anticipation score=75
...
- 2006 東和鋼鐵 setup=anticipation score=70
- 5876 上海商銀 setup=anticipation score=70
- 2605 新興 setup=anticipation score=70
