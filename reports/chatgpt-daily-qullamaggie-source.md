# ChatGPT Daily Qullamaggie Source: 2026-07-09

本資料包僅供 ChatGPT 排程研究與人工複核，不構成交易建議。

## 資料日期與 Freshness
- data_freshness: {'report_date': '2026-07-09', 'as_of_date': '2026-07-08', 'market_data_date': '2026-07-08', 'expected_market_data_date': '2026-07-08', 'latest_market_data_date': '2026-07-08', 'is_latest_trading_data_current': True, 'reason': 'Latest trading data is current'}
...
- market_regime: {'status': 'neutral', 'score': 8, 'reasons': ['benchmark regime=neutral'], 'risk_notes': [], 'metrics': {'listed': {'close': 45734.41, 'ma20': 45762.254, 'ma50': 43656.979, 'return_20d_pct': 2.304}, 'otc': {'close': 421.39, 'ma20': 430.0465, 'ma50': 423.3594, 'return_20d_pct': -0.7817}}}

## Setup Counts
- setup_counts: {'breakout': 0, 'episodic_pivot': 0, 'anticipation': 22, 'extended_watch': 33, 'failed_breakout': 23, 'insufficient_data': 50}

## Top Candidates
- 8096 擎亞 setup=anticipation score=73
- 3088 艾訊 setup=anticipation score=73
- 6199 天品 setup=anticipation score=63
- 6279 胡連 setup=anticipation score=63
- 2330 台積電 setup=anticipation score=63
- 2801 彰銀 setup=anticipation score=63
- 5876 上海商銀 setup=anticipation score=63
- 5880 合庫金 setup=anticipation score=63
- 2633 台灣高鐵 setup=anticipation score=63
- 8234 新漢 setup=anticipation score=58
- 4931 新盛力 setup=anticipation score=58
- 3416 融程電 setup=anticipation score=58
- 1477 聚陽 setup=anticipation score=58
- 2812 台中銀 setup=anticipation score=58
- 5392 能率 setup=anticipation score=53
- 2637 慧洋-KY setup=anticipation score=53
- 3596 智易 setup=anticipation score=53
- 2845 遠東銀 setup=anticipation score=53
- 1210 大成 setup=anticipation score=53
- 3005 神基 setup=anticipation score=48
