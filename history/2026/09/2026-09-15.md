...
- 執行時間：2026-09-15T04:09:51+08:00
- 交易日判定：True
- 最新市場資料日期：2026-09-14
- 是否足以執行全市場掃描：True
- 整體信心等級：high
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| TWSE | 主資料源 | True | 200 | 2026-09-14 | True | True | True |  |
| TPEx | 主資料源 | True | 200 | 2026-09-14 | True | True | True |  |
| data.gov.tw | 主資料源 | True | 200 |  | False | False | False | 未取得明確資料日期；不可判定為當日資料可用 |
| MOPS | 主資料源 | True | 200 | 2026-09-14 | True | True | True |  |
...
- listed_ohlcv：True（1379 listed rows parsed）
- otc_ohlcv：True（11289 OTC rows parsed）
...
- institutional_trading：True（17391 institutional rows parsed from official sources）
- margin_short：True（1982 margin/short rows parsed from official sources）
- material_information：True（MOPS material information query verified with 155 events）
