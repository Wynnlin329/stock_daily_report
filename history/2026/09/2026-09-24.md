...
- 執行時間：2026-09-24T03:26:26+08:00
- 交易日判定：True
- 最新市場資料日期：2026-09-23
- 是否足以執行全市場掃描：False
- 整體信心等級：medium
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| TWSE | 主資料源 | True | 200 | 2026-09-23 | True | True | True |  |
| TPEx | 主資料源 | True | 200 | 2026-09-23 | True | True | True |  |
| data.gov.tw | 主資料源 | True | 200 |  | False | False | False | 未取得明確資料日期；不可判定為當日資料可用 |
| MOPS | 主資料源 | True | 307 |  | False | False | False | HTTP 307: Temporary Redirect; HTTP 307: Temporary Redirect |
...
- MOPS：HTTP 307: Temporary Redirect; HTTP 307: Temporary Redirect
...
- otc_ohlcv：True（11696 OTC rows parsed）
...
- institutional_trading：True（18134 institutional rows parsed from official sources）
