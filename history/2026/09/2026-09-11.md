...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| TWSE | 主資料源 | True | 200 | 2026-09-10 | True | True | True |  |
| TPEx | 主資料源 | True | 200 | 2026-09-10 | True | True | True |  |
| data.gov.tw | 主資料源 | True | 200 |  | False | False | False | 未取得明確資料日期；不可判定為當日資料可用 |
| MOPS | 主資料源 | True | 200 | 2026-09-10 | True | True | True |  |
...
- otc_ohlcv：True（11179 OTC rows parsed）
...
- institutional_trading：True（17299 institutional rows parsed from official sources）
- margin_short：True（1982 margin/short rows parsed from official sources）
- material_information：True（MOPS material information query verified with 159 events）
