...
- 執行時間：2026-07-04T01:18:03+08:00
- 交易日判定：False
- 最新市場資料日期：2026-07-03
- 是否足以執行全市場掃描：False
- 整體信心等級：medium
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| TWSE | 主資料源 | True | 200 | 2026-07-03 | True | True | True |  |
| TPEx | 主資料源 | True | 200 | 2026-07-03 | True | True | True |  |
| data.gov.tw | 主資料源 | True | 200 |  | False | False | False | 未取得明確資料日期；不可判定為當日資料可用 |
| MOPS | 主資料源 | True | 307 |  | False | False | False | URLError: <urlopen error timed out>; HTTP 307: Temporary Redirect |
...
- MOPS：URLError: <urlopen error timed out>; HTTP 307: Temporary Redirect
...
- listed_ohlcv：True（1368 listed rows parsed）
- otc_ohlcv：True（9882 OTC rows parsed）
...
- institutional_trading：True（946 institutional rows parsed from official sources）
- margin_short：True（1963 margin/short rows parsed from official sources）
