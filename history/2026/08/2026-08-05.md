...
- 執行時間：2026-08-05T01:43:06+08:00
- 交易日判定：True
- 最新市場資料日期：2026-08-04
- 是否足以執行全市場掃描：False
- 整體信心等級：medium
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| TWSE | 主資料源 | True | 200 | 2026-08-04 | True | True | True |  |
| TPEx | 主資料源 | True | 200 | 2026-08-04 | True | True | True |  |
| data.gov.tw | 主資料源 | True | 200 |  | False | False | False | 未取得明確資料日期；不可判定為當日資料可用 |
| MOPS | 主資料源 | True | 200 |  | False | False | False | MOPSOV historical material information response returned security page; stop this source |
...
- MOPS：MOPSOV historical material information response returned security page; stop this source
...
- otc_ohlcv：True（10227 OTC rows parsed）
...
- institutional_trading：True（16071 institutional rows parsed from official sources）
- margin_short：True（1975 margin/short rows parsed from official sources）
...
- MOPSOV historical material information response returned security page; stop this source
